...
import { ShieldQuestionIcon, BackspaceIcon, ChoicesLogoIcon, CheckCircleIcon, UsersIcon, DownloadIcon } from './icons';
  ...
  const userSelectionView = (
     <div className="w-full max-w-md mx-auto">
        <div className="text-center">
            ...
            <p className="mt-2 text-md text-gray-600">Please select your profile to log in</p>
        </div>
        <div className="mt-8">
    ...
    <div className="flex items-center justify-center h-full p-4 sm:p-6">
      <div className="w-full max-w-4xl backdrop-blur-xl bg-white/40 border border-white/50 shadow-2xl rounded-2xl flex overflow-hidden min-h-[600px] md:min-h-[650px]">
        ...
        <div className="hidden md:flex w-1/2 p-12 text-white flex-col justify-center items-center text-center animate-illuminate">
          <ChoicesLogoIcon className="w-36 h-36" variant="white" />
          <p className="mt-6 text-xl text-white/90 max-w-sm">Dedicated to providing a safe and nurturing environment.</p>
          <div className="mt-8 border-t border-white/50 w-2/3"></div>
          <div className="mt-8 text-left text-white/80 space-y-3 self-center">
            <h3 className="text-lg font-semibold text-white text-center mb-4">Key Features</h3>
            <p className="flex items-center gap-3"><CheckCircleIcon className="w-5 h-5 flex-shrink-0" /> Collaborative Form Filling</p>
            <p className="flex items-center gap-3"><UsersIcon className="w-5 h-5 flex-shrink-0" /> User & Role Management</p>
