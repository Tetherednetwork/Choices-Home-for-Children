...
const LoginScreen: React.FC<LoginScreenProps> = ({ users, onLogin }) => {
  ...
  if (selectedUser) {
    return (
      <div className="flex items-center justify-center min-h-screen">
        <div className="relative w-full max-w-sm p-8 space-y-6 backdrop-blur-xl bg-white/40 border border-white/50 shadow-2xl rounded-2xl text-center">
  ...
  return (
    <div className="flex items-center justify-center min-h-screen">
      <div className="w-full max-w-md p-8 space-y-8 backdrop-blur-xl bg-white/40 border border-white/50 shadow-2xl rounded-2xl">
